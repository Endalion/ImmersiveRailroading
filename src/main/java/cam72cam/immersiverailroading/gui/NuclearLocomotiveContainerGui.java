...
public class NuclearLocomotiveContainerGui extends ContainerGuiBase {
	
	private int inventoryRows;
	private int horizSlots;
	private LocomotiveNuclear stock;
	private ItemStack template;

    public NuclearLocomotiveContainerGui(LocomotiveNuclear stock, NuclearLocomotiveContainer container) {
        super(container);
        this.stock = stock;
    	...
    	try {
	    	...
	    	for (int slot : burnTime.keySet()) {
	    		...
	    		if (time != 0) {
	    			...
	    			TextureAtlasSprite sprite = mc.getTextureMapBlocks().getAtlasSprite("minecraft:blocks/lava_flow");
