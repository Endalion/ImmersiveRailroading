...
public class NuclearLocomotiveContainer extends ContainerBase {
	
	private LocomotiveNuclear Tank;
	protected int numRows;

	public NuclearLocomotiveContainer(IInventory playerInventory, LocomotiveNuclear stock) {
		this.Tank = stock;
