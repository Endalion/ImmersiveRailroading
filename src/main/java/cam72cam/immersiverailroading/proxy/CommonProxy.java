...
public abstract class CommonProxy implements IGuiHandler {
    ...
    public static void registerEntities(RegistryEvent.Register<EntityEntry> event) {
    	...
    	EntityRegistry.registerModEntity(new ResourceLocation(ImmersiveRailroading.MODID, NPCPorter.class.getSimpleName()), NPCPorter.class, NPCPorter.class.getSimpleName(), ++lastEntityID, ImmersiveRailroading.instance, ImmersiveRailroading.ENTITY_SYNC_DISTANCE, 3, true);
    }
